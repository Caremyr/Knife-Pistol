...
let WilliamImg = UIImage(named: "DeadWilliam.png")!
//Importing William Sprite
let FatherImg = UIImage(named: "DeadFather.png")!
...
class PrologueController: UIViewController{
    ...
    @objc func nextLabel(){
        if(counter == 0){
            ...
            WilliamSprite.frame = CGRect(x: -30, y: Vista.frame.midY - 125, width: WilliamImg.size.width/3, height: WilliamImg.size.height/3)
            ...
            FatherSprite.frame = CGRect(x: 320, y: 65, width: FatherImg.size.width/3, height: FatherImg.size.height/3)
