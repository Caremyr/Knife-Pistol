...
let narrazione = [
    ...
    "William Rigor Zeppeli, a petty thief who lived in the slums, ran away from home when he was only 12. He made his living by selling what he managed to pickpocket and steal.",
    "But this time William did not steal mere junk, like he usually stole from the stalls, today he got his hands on something much better, something very valuable.",
    "End of Prologue"
]
...
let urlString = Bundle.main.path(forResource: "BackgroundSound", ofType: "mp3")
